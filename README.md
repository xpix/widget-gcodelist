...
$(".com-chilipeppr-widget-gcode-toolchange-additionalContent").html('<iframe frameBorder="0" width="100%" src="' + additionalContent + '"></iframe>');
...
}<br><br>// unsub so we don't get anymore callbacks on this
